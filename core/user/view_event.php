...
<?php
if(isset($_GET['id'])){
$qry = $conn->query("SELECT e.* FROM events e where e.id= ".$_GET['id']);
		...
		<div class="card">
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-12">
						<h4 class="text-center"><b><?php echo ucwords($name) ?></b></h4>
						<p class="text-center"><small><b><i>Venue: <?php echo ucwords($venue_name) ?></small></i></b></p>
