		...
		<div class="card">
			<div class="card-body">
				<form action="" id="manage-event">
					...
					<div class="form-group row">
						<div class="col-md-5">
							<label for="" class="control-label">Vanue Name</label>
							<input type="text" class="form-control" name="venue_name"  value="<?php echo isset($venue_name) ? $venue_name :'' ?>" required autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-5">
							<label for="" class="control-label">Address</label>
							<input type="text" class="form-control" name="address"  value="<?php echo isset($address) ? $address :'' ?>" required autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-10">
					...
					<div class="form-group row" <?php echo isset($payment_type) && $payment_type == 1 ? "style='display:none'" : '' ?>>
						<div class="col-md-5">
							...
							<input type="number" step="any" class="form-control text-right" name="attendance_fees" id ='attendance_fees'  value="<?php echo isset($attendance_fees) ? $attendance_fees :0 ?>" required autocomplete="off">
						</div>
					</div>
